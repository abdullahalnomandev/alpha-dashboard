...
const LoginPage: React.FC = () => {
  ...
  const onFinish = async (values: { email: string; password: string }) => {
    try {
      ...
      // Solve catching err (RTK Query will throw a serializable object, not error instance)
      let errorObj = err;
      // err may be instance of FetchBaseQueryError or FetchBaseQuerySerializedError
      if (typeof err === "object" && err !== null) {
        // RTK Query error shape (for REST, unwrapped)
        // Example: { status: 401, data: { ... } }
        // data may contain errorMessages or message
        if ((err as any).data) {
